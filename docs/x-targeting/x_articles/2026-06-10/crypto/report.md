# Native X Articles — crypto — 2026-06-10

## TL;DR

Stored **0 native X Articles** from **0 searched tweets** since `2026-06-09T10:50:55.795464+00:00`.
Search mode: **both**.
...
| `broad-native-top` | `Top` | `(crypto OR DeFi OR onchain OR blockchain OR Web3 OR perp OR perps OR DEX OR token) url:x.com/i/article since:2026-06-09 -is:retweet` |
| `keyword-native-top` | `Top` | `(crypto OR DeFi OR onchain OR blockchain OR Web3 OR perp OR perps OR DEX OR token) url:x.com/i/article since:2026-06-09 -is:retweet min_faves:5` |
| `keyword-native-latest` | `Latest` | `(crypto OR DeFi OR onchain OR blockchain OR Web3 OR perp OR perps OR DEX OR token) url:x.com/i/article since:2026-06-09 -is:retweet` |
