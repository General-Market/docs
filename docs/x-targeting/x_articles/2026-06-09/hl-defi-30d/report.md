# Native X Articles — hl-defi-30d — 2026-06-09
...
| 6 | [Grayscale debuts cheapest Hyperliquid ETF as rivals race for HYPE inflows](https://x.com/i/article/2062190071143333889) | [@Crypto_Briefing](https://x.com/Crypto_Briefing) | 3 eng / 3500 views / 0.857 eng per 1k views | 5.2 | 54.93 per 1k | 4.888x | Read and extract pattern (~5 min) |
...
| label | type | query |
|---|---|---|
| `likes-gte-5000` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:5000 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `likes-gte-2000` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:2000 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `likes-gte-1000` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:1000 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `likes-gte-500` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:500 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `likes-gte-250` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:250 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `likes-gte-100` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:100 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `likes-gte-50` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:50 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `likes-gte-25` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:25 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `likes-gte-10` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:10 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `likes-gte-5` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:5 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `likes-gte-2` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:2 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `likes-gte-1` | `Top` | `("HLP vault" OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq OR Hyperdrive) min_faves:1 url:x.com/i/article since:2026-05-10 -is:retweet` |
| `broad-native-top` | `Top` | `(HLP OR "HLP vault" OR Hyperliquid OR HyperEVM) (vault OR lending OR looping OR staking OR LST OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq) url:x.com/i/article since:2026-05-10 -is:retweet` |
| `keyword-native-top` | `Top` | `(HLP OR "HLP vault" OR Hyperliquid OR HyperEVM) (vault OR lending OR looping OR staking OR LST OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq) url:x.com/i/article since:2026-05-10 -is:retweet min_faves:5` |
| `keyword-native-latest` | `Latest` | `(HLP OR "HLP vault" OR Hyperliquid OR HyperEVM) (vault OR lending OR looping OR staking OR LST OR stHYPE OR Felix OR HypurrFi OR HyperLend OR Hyperbeat OR Kinetiq) url:x.com/i/article since:2026-05-10 -is:retweet` |
