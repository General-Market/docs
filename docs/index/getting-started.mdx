...
<Info>
Behind the button: three issuer nodes reach [consensus](/index/concepts/order-lifecycle), a real exchange executes real trades, and ITP tokens are minted to your wallet. This takes a few seconds. The machinery is invisible by design.
</Info>
