...
The same formula runs on-chain in `Index.sol`, off-chain in the issuer nodes, and in the frontend. Three places, one truth. If they ever disagree, something is very wrong.
