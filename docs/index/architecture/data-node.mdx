...
<img src="/images/index/data-node-overview.svg" alt="Data Node — 91 sources funnel through Rust collectors into PostgreSQL, served by 50+ REST endpoints, WebSocket and SSE." />
...
<img src="/images/index/data-node-collectors.svg" alt="Source APIs feed SyncEngines through spawn_resilient. A shared BatchWriter coalesces inserts into PostgreSQL and broadcasts to WebSocket subscribers." />
...
<img src="/images/index/chain-pollers.svg" alt="L3 and Settlement chain reads collapse into a single in-memory ChainCache served by the REST API." />
...
<img src="/images/index/postgres-schema.svg" alt="PostgreSQL schema — fifteen tables across five groups, the fossil record of every feature that survived." />
...
<img src="/images/index/websocket-subscribe.svg" alt="WebSocket subscribe / broadcast / unsubscribe handshake between client, Data Node, and the 91 source engines." />
