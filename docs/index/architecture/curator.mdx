...
<img src="/images/index/curator-service.svg" alt="Curator service with four concurrent tasks feeding settlement-chain contracts." />
...
<img src="/images/index/nav-oracle-flow.svg" alt="NAV oracle flow: three signed reads, aggregated, validated, pushed to ITPNAVOracle." />
...
<img src="/images/index/collection-loop.svg" alt="Collector loop: collect, validate, push if new cycle, sleep, repeat." />
...
<img src="/images/index/utilization-targets.svg" alt="Market utilization bands and the bot's response in each." />
...
<img src="/images/index/risk-tiers.svg" alt="Risk tier concentration caps from 30 percent down to 5 percent." />
...
<img src="/images/index/allocation-cycle.svg" alt="Allocation cycle: detect markets, read state, decide, then move USDC or skip." />
...
<img src="/images/index/health-monitor-scan.svg" alt="Six probes feeding a HealthReport that fans out to Telegram, logs, and shared state." />
...
<img src="/images/index/health-factor-thresholds.svg" alt="Health factor thresholds: liquidatable, critical, and healthy bands." />
...
<img src="/images/index/crisis-levels.svg" alt="Crisis levels from Normal through Emergency with their Quote API responses." />
...
<img src="/images/index/quote-flow.svg" alt="Quote flow from borrow form through curator computation to settlement and back." />
...
<img src="/images/index/shared-state.svg" alt="Shared state hub: writers on the left, readers on the right, lock in the middle." />
...
<img src="/images/index/alerting.svg" alt="Health report through the dispatcher into Telegram or a tracing-log fallback." />
...
<img src="/images/index/curator-end-to-end.svg" alt="End-to-end: three signed NAVs into curator into four settlement-chain outputs." />
