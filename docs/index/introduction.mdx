...
<img src="/images/index/three-pillars.svg" alt="Index, Vision, and Lending — the three product surfaces of General Market." />
...
<img src="/images/index/user-lifecycle.svg" alt="Three user paths — buying an ITP, betting on Vision, supplying USDC — and what the protocol does between intent and outcome." />
...
<img src="/images/index/system-architecture-overview.svg" alt="System architecture — frontend, data node, Index L3, oracles, AP, Settlement, and the satellite services around them." />
...
<img src="/images/index/convictions.svg" alt="Four convictions — BLS consensus, real execution, sealed parimutuel betting, and 90+ data sources." />
