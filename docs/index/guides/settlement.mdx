...
<img src="/images/index/two-chains-overview.svg" alt="The two chains side by side — L3 hosts trading, Vision, and core protocol; Settlement hosts the bridge, BridgedITP, Morpho, and Vision deposits." />
...
<img src="/images/index/which-chain.svg" alt="Which chain do I need — common actions mapped to L3 or Settlement." />
...
<img src="/images/index/usdc-decimals.svg" alt="100 USDC in raw units — six decimals on Settlement, eighteen on L3, a 1e12 ratio handled by DecimalLib." />
...
<img src="/images/index/bridge-buy-sell.svg" alt="Bridge buy and sell flows — what happens on Settlement and on L3 in each direction." />
...
<img src="/images/index/quick-reference.svg" alt="Quick reference card — chain IDs, RPCs, native tokens, USDC decimals, and what lives on each side." />
