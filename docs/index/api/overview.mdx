...
```
  METHOD   PATH                          UPSTREAM          DESCRIPTION
  ------   ----------------------------  ----------------  --------------------------------
  GET      /api/vision/batches           Issuer API        List active prediction batches
  POST     /api/vision/bitmap            All Issuers       Fan-out bitmap submission
  GET      /api/vision/leaderboard       Issuer API        Player PnL rankings
