...
description: "Navigate Vision's 98+ data sources — find markets, view price history, and understand source categories"
---
...
Vision draws from 98+ real-world data sources spanning 10 categories. The Sources browser is the main entry point for discovering what you can bet on.
...
```
    ...
    │    Winners split losers' stakes (minus 0.3% fee on profits)       │
    │                                                                    │
    └────────────────────────────────────────────────────────────────────┘
```
...
<CardGroup cols={2}>
  <Card title="Data Sources Reference" icon="database" href="/vision/concepts/sources">
    The full directory: 98+ sources, their prefixes, value labels, units, update frequencies. The catalog of measurable things.
  </Card>
