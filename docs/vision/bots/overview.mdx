...
<Warning>
**USDC uses 6 decimals, not 18.** Multiply token amounts by `10^6`. 10 USDC = `10_000_000` (not `10_000_000_000_000_000_000`). Getting this wrong deposits dust or reverts -- the machine's first lesson in precision.
</Warning>
