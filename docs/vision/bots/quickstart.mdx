...
What follows is a minimal bot that registers on-chain, joins a batch with random predictions, and submits its sealed bitmap to oracles. It will not outperform chance. That comes later -- if it comes at all.
...
```bash
export RPC_URL="http://142.132.164.24/"
