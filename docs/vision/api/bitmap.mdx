...
Reveal what you committed to. Submit your prediction bitmap to the issuer node. The bitmap must match the keccak256 hash you sealed on-chain -- the moment where commitment becomes confession.
