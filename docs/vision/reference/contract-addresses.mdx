...
<img src="/images/vision/contract-topology.svg" alt="Vision contract topology on Index L3 — Vision contract with Batches, Players, Bot registry, plus L3 WUSDC and OracleRegistry" />
