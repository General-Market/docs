...
A batch creator can change which markets are included, but not unilaterally. Altering the rules of a game that people have already entered requires BLS issuer consensus -- the closest thing to democratic oversight a smart contract can offer:
