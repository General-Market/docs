...
<img src="/images/vision/data-pipeline-flow.svg" alt="External APIs funnel into the Rust data node, then Postgres, then the Vision API, then the frontend." />
...
<img src="/images/vision/source-category-map.svg" alt="Nine category cards in a three-by-three grid, each listing the sources it contains and the total count." />
...
<img src="/images/vision/source-to-market-flow.svg" alt="Source API to data node to on-chain BLS-signed oracle submission, in three swim lanes." />
...
<img src="/images/vision/market-id-convention.svg" alt="Ten worked examples of prefix and asset combining into a full market ID." />
...
<img src="/images/vision/rate-limit-examples.svg" alt="Seven sources with their upstream rate limit and the polling strategy used to honor it." />
...
<img src="/images/vision/new-source-files.svg" alt="Six numbered steps with file paths required to register a new data source end-to-end." />
