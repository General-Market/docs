...
export function AnimatedLeaderboardRow({
  ...
  return (
    <motion.tr
      ...
      className={`cursor-pointer hover:bg-card-hover focus:outline-none focus:ring-2 focus:ring-brand/30 transition-colors duration-300 ${highlightClass} ${rankChangeClass}`}
