...
export function LeaderboardTable({ highlightedAddress }: LeaderboardTableProps = {}) {
  ...
  if (isError) {
    return (
      <div className="border border-color-down/50 rounded-xl p-6 text-center" role="alert">
  ...
  return (
    <div className="border border-border-light rounded-xl shadow-card overflow-hidden">
      {/* Table Header */}
      <div className="bg-muted px-4 py-3 border-b border-border-medium flex justify-between items-center">
        <div>
          <h3 className="text-lg font-bold text-text-primary">Agent Leaderboard</h3>
