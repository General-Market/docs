...
// Article scene timing (frames) — kept snappy so attention doesn't drift
export const ARTICLE_DUR = 296;
export const GRAPH_DUR = 200;
export const GRAPH_START = 284;
export const TOTAL = GRAPH_START + GRAPH_DUR;
