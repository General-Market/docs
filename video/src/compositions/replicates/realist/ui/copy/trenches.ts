...
export const ZOOM_TABLE: ZoomKey[] = [
  ...
  { f: 55, s: 1.2798, tx: 14.0, ty: 2.9 },
  { f: 60, s: 1.3054, tx: 15.6, ty: 3.2 },
  { f: 65, s: 1.3245, tx: 16.7, ty: 3.3 },
  { f: 70, s: 1.3389, tx: 17.6, ty: 3.4 },
  { f: 75, s: 1.3494, tx: 18.3, ty: 3.5 },
  ...
  { f: 160, s: 1.36, tx: 18.5, ty: 2.3 },
  { f: 170, s: 1.3459, tx: 17.1, ty: 3.4 },
  ...
  { f: 215, s: 1.0759, tx: 3.8, ty: 0.9 },
  { f: 220, s: 1.0521, tx: 3.1, ty: 0.8 },
  { f: 225, s: 1.037, tx: 1.7, ty: 0.8 },
  { f: 230, s: 1.0257, tx: 1.6, ty: 0.7 },
  { f: 235, s: 1.0175, tx: 1.2, ty: 0.7 },
