...
// Same two faces as frontend/app/layout.tsx — Geist Sans + JetBrains Mono.
const { fontFamily: jetbrainsMono } = loadJetBrainsMono();
const { fontFamily: geistSans } = loadGeist();

export const GM_MONO_FONT = jetbrainsMono;
export const GM_DISPLAY_FONT = geistSans;

// Mirrors frontend/app/globals.css :root.
export const GM_BG = "#FFFFFF";
export const GM_FG = "#1A1A1A";
export const GM_SURFACE = "#F4F6F5";
export const GM_BORDER = "#E0E0E0";
export const GM_BORDER_STRONG = "#000000";
export const GM_BRAND = "#00A36C";
export const GM_UP = "#16A34A";
export const GM_DOWN = "#DC2626";
export const GM_MUTED = "#999999";
export const GM_TEXT_SECONDARY = "#555555";

// Dark counterparts for cards layered on light backgrounds — borrowed from
// frontend/app/globals.css .glass-panel-dark gradient stops.
export const GM_DARK_BG = "#0A0A0A";
export const GM_DARK_CARD = "#1A1A1A";
export const GM_DARK_BORDER = "rgba(255,255,255,0.08)";

export const GM_TITLE_FONT_SIZE = 56;

/**
 * General Market wordmark logo. Same SVG as frontend/public/logo.svg —
 * black square with seven white capsules forming the dot-matrix wordmark.
 *
 * `tone` lets you flip to inverted (white square, black bars) for dark backgrounds.
 */
export const GMLogo: React.FC<{ size?: number; tone?: "default" | "inverted" }> = ({
  size = 96,
  tone = "default",
}) => {
  const square = tone === "inverted" ? "#FFFFFF" : "#000000";
  const bars = tone === "inverted" ? "#000000" : "#FFFFFF";
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path d="M0 0H102V102H0V0Z" fill={square} />
      <path
...
/**
 * "General Market" wordmark — Geist Sans 900, tight tracking. Mirrors the
 * homepage Header brand text (font-black, tracking-[-0.03em]).
 */
export const GMWordmark: React.FC<{
  size?: number;
  color?: string;
}> = ({ size = 56, color = GM_FG }) => (
  <span
    style={{
      fontFamily: GM_DISPLAY_FONT,
      fontWeight: 900,
      fontSize: size,
