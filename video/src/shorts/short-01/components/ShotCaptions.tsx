...
const phraseFontSize = (
  ...
  if (totalWidth <= maxCapWidth) return baseFontSize;
  ...
  const shrinkRatio = maxCapWidth / longestWordWidth;
...
export const ShotCaptions: React.FC<Props> = ({
  ...
  const baseFontSize = mode === "shout" ? layout.captionFontShout : layout.captionFontQuiet;
  const fontSize = phraseFontSize(activePhrase, highlights, mode, baseFontSize, layout.captionMaxWidth);
  ...
  return (
    <div
      style={{
        ...
        zIndex: 20,
        textAlign: "center",
        padding: `0 ${layout.captionPadX}px`,
