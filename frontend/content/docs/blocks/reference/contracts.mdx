...
A block is a continuous prediction market tied to a real-world data source. Each block operates on a tick-based clock -- predictions lock before each tick resolves. Time, sliced into intervals of judgment:
