...
For each market in the block, decide UP or DOWN. The quickstart uses random bets -- the purest confession of ignorance. See [Example Strategies](/vision/bots/strategies) for approaches that disguise ignorance as method.
...
See [Bot Development](/vision/bots/development) for the full claim and withdrawal flow.
