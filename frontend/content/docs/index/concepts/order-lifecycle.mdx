...
<img src="/images/index/sell-flow.svg" alt="Sell flow infrastructure diagram — DTF shares escrowed on L3, oracle BLS consensus batches order, AP sells on Bitget, USDC returned to Settlement custody, completeSellOrder pays user, confirmFills burns shares on L3" />
