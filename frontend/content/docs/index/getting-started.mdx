...
<Info>
Behind the button: three oracle nodes reach [consensus](/index/concepts/order-lifecycle), a real exchange executes real trades, and DTF tokens are minted to your wallet. This takes a few seconds. The machinery is invisible by design.
</Info>
...
- Deposit DTF tokens into [lending markets](/index/concepts/lending) — to earn yield, or to borrow against what you own but cannot part with
