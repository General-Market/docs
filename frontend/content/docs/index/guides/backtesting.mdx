...
The engine simulates portfolio performance from 2020 to today. Test a thesis, compare configurations via sweep mode, and deploy the result as a live Dex Traded Fund (DTF) -- from the UI or API.
