...
Three endpoints keyed by wallet address.

| Endpoint | Returns |
|---|---|
| `/portfolio` | Current DTF positions, total value, total PnL |
| `/portfolio/history` | Portfolio value over time |
| `/portfolio/trades` | Every buy and sell on-chain |

---

## Get Portfolio Summary

Returns all DTF positions, total value, and profit/loss for a wallet.
...
Next: [Get Portfolio History](#get-portfolio-history) for the time series.

---

## Get Portfolio History

Returns portfolio value in USD over time as `{timestamp, value_usd}` points.
...
Next: [Get Trade History](#get-trade-history) for individual fills.

---

## Get Trade History

Returns every buy and sell for a wallet, with tx hash, shares, price, and fee.
...
Next: [Simulation API](/index/api/simulation) to backtest strategies.
