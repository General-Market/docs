...
description: "Step-by-step tutorial: scaffold a trading bot with npx generalmarket init, connect to data sources, write a strategy, and deploy to Vision's 400,000+ prediction markets."
...
A tutorial without measured outcomes is a recipe without a photo of the dish.
