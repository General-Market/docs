              ...
              <div className="ml-auto flex items-center gap-3 live-ambient-pulse">
                <div className="flex items-center gap-2">
                  <span className="relative flex h-2.5 w-2.5">
                    ...
                    <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-color-up" />
                  </span>
                  <span className="text-caption font-bold text-color-up uppercase tracking-[0.08em]">Live</span>
                </div>
                <span className="text-label font-mono font-bold text-white/40">Oracle Consensus</span>
                <button
