...
export default function StrategyList({ bitmapEditor, sourceId, marketIds }: StrategyListProps) {
  ...
  return (
    <div className="mt-4 space-y-3">
      ...
      <div>
        <h3 className="text-[9px] font-bold tracking-[0.08em] text-text-muted uppercase mb-1.5">
          Strategies
        </h3>
        <div className="flex gap-1.5 stagger">
          {STRATEGIES.map((strategy) => (
            <button
              ...
              className="flex-1 rounded-md border border-border-light bg-[var(--surface)] px-2 py-1.5 hover:border-brand disabled:opacity-40 disabled:cursor-not-allowed transition-colors text-left animate-fade-up"
            >
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-1.5 stagger">
          {/* Claude Code */}
          <button type="button" onClick={() => setSelectedAgent('claude-code')} className="animate-fade-up flex items-center gap-2 rounded-md border border-terminal px-2 py-1.5 text-label font-bold text-text-secondary hover:bg-terminal hover:text-white transition-colors">
          ...
          {/* Cursor */}
          <button type="button" onClick={() => setSelectedAgent('cursor')} className="animate-fade-up flex items-center gap-2 rounded-md border border-terminal px-2 py-1.5 text-label font-bold text-text-secondary hover:bg-terminal hover:text-white transition-colors">
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none">
          ...
          {/* Windsurf */}
          <button type="button" onClick={() => setSelectedAgent('windsurf')} className="animate-fade-up flex items-center gap-2 rounded-md border border-terminal px-2 py-1.5 text-label font-bold text-text-secondary hover:bg-terminal hover:text-white transition-colors">
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none">
          ...
          {/* Devin */}
          <button type="button" onClick={() => setSelectedAgent('devin')} className="animate-fade-up flex items-center gap-2 rounded-md border border-terminal px-2 py-1.5 text-label font-bold text-text-secondary hover:bg-terminal hover:text-white transition-colors">
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none">
          ...
          <button type="button" onClick={() => setSelectedAgent('cline')} className="col-span-2 animate-fade-up flex items-center gap-2 rounded-md border border-terminal px-2 py-1.5 text-label font-bold text-text-secondary hover:bg-terminal hover:text-white transition-colors">
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none">
