    ...
    <div className="mt-4 space-y-3">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-1.5">
          {/* Claude Code */}
          <button type="button" onClick={() => setSelectedAgent('claude-code')} className="flex items-center gap-2 rounded-md border border-[#18181B] px-2 py-1.5 text-label font-bold text-[#52525b] hover:bg-[#18181B] hover:text-white transition-colors">
          ...
          {/* Cursor */}
          <button type="button" onClick={() => setSelectedAgent('cursor')} className="flex items-center gap-2 rounded-md border border-[#18181B] px-2 py-1.5 text-label font-bold text-[#52525b] hover:bg-[#18181B] hover:text-white transition-colors">
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none">
          ...
          {/* Windsurf */}
          <button type="button" onClick={() => setSelectedAgent('windsurf')} className="flex items-center gap-2 rounded-md border border-[#18181B] px-2 py-1.5 text-label font-bold text-[#52525b] hover:bg-[#18181B] hover:text-white transition-colors">
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none">
          ...
          {/* Devin */}
          <button type="button" onClick={() => setSelectedAgent('devin')} className="flex items-center gap-2 rounded-md border border-[#18181B] px-2 py-1.5 text-label font-bold text-[#52525b] hover:bg-[#18181B] hover:text-white transition-colors">
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none">
          ...
          <button type="button" onClick={() => setSelectedAgent('cline')} className="col-span-2 flex items-center gap-2 rounded-md border border-[#18181B] px-2 py-1.5 text-label font-bold text-[#52525b] hover:bg-[#18181B] hover:text-white transition-colors">
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none">
