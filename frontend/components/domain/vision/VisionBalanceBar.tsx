  ...
  return (
    <>
      <div className="flex items-center gap-1.5 sm:gap-2">
        <span className="text-caption font-bold font-mono tabular-nums text-black">
        ...
        {hasBalance && (
          <button
            ...
            className="hidden sm:inline-flex px-2.5 py-1 bg-muted text-text-secondary text-label font-bold rounded border border-border-light hover:bg-surface transition-colors"
          >
            WITHDRAW
          </button>
        )}
