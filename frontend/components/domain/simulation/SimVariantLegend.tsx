...
export function SimVariantLegend({ variants, onDeployIndex }: SimVariantLegendProps) {
  ...
  return (
    <div className="border border-border-light rounded-card bg-card p-3 space-y-0.5">
        ...
        return (
          ...
          >
            ...
            {isHovered && onDeployIndex && (
              <button
                className="text-micro font-medium px-2 py-0.5 bg-brand text-white rounded hover:bg-brand-dark transition-colors flex-shrink-0 whitespace-nowrap"
                onClick={(e) => {
                  e.stopPropagation()
