...
export function EIPTimeline() {
  return (
    <div className="my-16 -mx-4 md:-mx-8">
      <div className="bg-surface border-t-[3px] border-b border-black border-b-border-light px-6 md:px-10 py-10">
        {/* Header */}
        <p className="text-micro text-text-muted tracking-[0.08em] uppercase mb-8">
        ...
        <div className="relative">
          {/* Horizontal line */}
          <div className="absolute top-[28px] left-0 right-0 h-[1px] bg-border-medium" />
