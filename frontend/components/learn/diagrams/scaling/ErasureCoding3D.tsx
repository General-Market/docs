  ...
  return (
    <div className="flex items-center gap-5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-[0.08em]">Parity</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-2 h-2 rounded-full" style={{ backgroundColor: COL_GREEN }} />
        <span className="text-micro text-text-muted tracking-[0.08em]">Online</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-2 h-2 rounded-full" style={{ backgroundColor: COL_RED }} />
        <span className="text-micro text-text-muted tracking-[0.08em]">Offline</span>
      </div>
    </div>
  )
}
