  ...
  return (
    <div className="flex items-center gap-4 flex-wrap">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-[0.08em]">Read slot</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-2.5 h-2.5 rounded-full" style={{ backgroundColor: COL_WRITE }} />
        <span className="text-micro text-text-muted tracking-[0.08em]">Write slot</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: COL_CONFLICT }} />
        <span className="text-micro text-text-muted tracking-[0.08em]">Conflict</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: COL_LANE }} />
        <span className="text-micro text-text-muted tracking-[0.08em]">Parallel Lane</span>
      </div>
    </div>
  )
}
