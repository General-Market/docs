  ...
  return (
    <div className="flex items-center gap-5">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-[0.08em]">Mixed bytecode</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: '#3b82f6' }} />
        <span className="text-micro text-text-muted tracking-[0.08em]">Code</span>
      </div>
      <div className="flex items-center gap-1.5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-[0.08em]">Analysis</span>
      </div>
    </div>
  )
}
