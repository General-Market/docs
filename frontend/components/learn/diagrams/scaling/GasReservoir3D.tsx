  ...
  return (
    <div className="flex items-center gap-4 flex-wrap">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-wide">State creation</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ background: COL_AMBER }} />
        <span className="text-micro text-text-muted tracking-wide">Reservoir</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ background: COL_RED }} />
        <span className="text-micro text-text-muted tracking-wide">Overflow / spike</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm bg-zinc-400 border border-zinc-500" />
        <span className="text-micro text-text-muted tracking-wide">Legacy contract</span>
      </div>
    </div>
  )
}
