  ...
  return (
    <div className="flex items-center gap-5">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-wide">Producer</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: COL_INDIGO }} />
        <span className="text-micro text-text-muted tracking-wide">Blob Cells</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: COL_GREEN }} />
        <span className="text-micro text-text-muted tracking-wide">Validators</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: COL_VIOLET }} />
        <span className="text-micro text-text-muted tracking-wide">KZG</span>
      </div>
    </div>
  )
}
