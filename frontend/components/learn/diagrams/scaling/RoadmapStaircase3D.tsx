...
function MultiplierLabel({
  ...
  return (
    <Html
      ...
      style={{ pointerEvents: 'none', userSelect: 'none' }}
    >
      <p className="text-heading font-bold font-mono whitespace-nowrap text-color-up">
        ×10
      </p>
    </Html>
  )
        ...
        return (
          <group key={year} position={[x, 0, 0]}>
            ...
            <Html
              ...
              style={{ pointerEvents: 'none', userSelect: 'none' }}
            >
              <p className="text-micro text-text-muted font-mono whitespace-nowrap">{year}</p>
            </Html>
          </group>
        )
      })}
  ...
  return (
    <div className="flex items-center gap-5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-[0.08em]">Data</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm bg-violet-400 border border-violet-500" />
        <span className="text-micro text-text-muted tracking-[0.08em]">Proofs</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm bg-green-500 border border-green-600" />
        <span className="text-micro text-text-muted tracking-[0.08em]">×10 multiplier</span>
      </div>
    </div>
  )
}
