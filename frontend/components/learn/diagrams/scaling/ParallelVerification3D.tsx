  ...
  return (
    <div className="flex items-center gap-5">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-wide">Sequential</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: '#22c55e' }} />
        <span className="text-micro text-text-muted tracking-wide">Parallel</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: '#f59e0b' }} />
        <span className="text-micro text-text-muted tracking-wide">Shared Slots</span>
      </div>
    </div>
  )
}
