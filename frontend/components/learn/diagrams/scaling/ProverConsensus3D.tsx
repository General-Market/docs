  ...
  return (
    <div className="flex items-center gap-5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-wide">Valid proof</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: RED }} />
        <span className="text-micro text-text-muted tracking-wide">Buggy proof</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: AMBER }} />
        <span className="text-micro text-text-muted tracking-wide">Flagged</span>
      </div>
    </div>
  )
}
