  ...
  return (
    <div className="flex items-center gap-5 flex-wrap">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-wide">ZK Paymaster (Frame 0)</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: GREEN }} />
        <span className="text-micro text-text-muted tracking-wide">Withdrawal (Frame 1)</span>
      </div>
      <div className="flex items-center gap-1.5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-wide">No link</span>
      </div>
    </div>
  )
}
