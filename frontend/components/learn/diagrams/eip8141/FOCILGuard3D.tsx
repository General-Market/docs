  ...
  return (
    <div className="flex items-center gap-4 flex-wrap">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-[0.08em]">Simple TX</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: PURPLE }} />
        <span className="text-micro text-text-muted tracking-[0.08em]">Multisig</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: INDIGO }} />
        <span className="text-micro text-text-muted tracking-[0.08em]">Paymaster</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: PINK }} />
        <span className="text-micro text-text-muted tracking-[0.08em]">Privacy</span>
      </div>
      <div className="flex items-center gap-1.5">
        <div className="w-3 h-2 rounded-sm" style={{ backgroundColor: GREEN }} />
        <span className="text-micro text-text-muted tracking-[0.08em]">FOCIL shield</span>
      </div>
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-[0.08em]">Censored</span>
      </div>
    </div>
  )
}
