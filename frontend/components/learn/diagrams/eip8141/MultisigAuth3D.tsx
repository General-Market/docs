  ...
  return (
    <Html center position={[VAULT_POS.x, VAULT_POS.y + 1.35, VAULT_POS.z]} style={{ pointerEvents: 'none', userSelect: 'none' }}>
      <div ref={ref} style={{ opacity: 0, transition: 'opacity 0.15s' }}>
        <p className="text-body font-bold font-mono whitespace-nowrap tracking-[0.08em]" style={{ color: GREEN }}>ACCEPT</p>
      </div>
    </Html>
  )
}
...
function CalldatareadLabel({ reducedMotion }: { reducedMotion: boolean }) {
  ...
  return (
    <Html center position={[midPos.x, midPos.y, midPos.z]} style={{ pointerEvents: 'none', userSelect: 'none' }}>
      <div ref={ref} style={{ opacity: 0, transition: 'opacity 0.15s' }}>
        <p className="text-[9px] font-mono font-bold whitespace-nowrap tracking-[0.08em]" style={{ color: AMBER }}>CALLDATAREAD</p>
      </div>
    </Html>
  )
}
  ...
  return (
    <div className="flex items-center gap-5">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-[0.08em]">Signatures</span>
      </div>
      <div className="flex items-center gap-1.5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-micro text-text-muted tracking-[0.08em]">ACCEPT + Execution</span>
      </div>
    </div>
  )
}
