  ...
  return (
    <div className="hero-band">
      <div className="hero-band-inner">
        {/* Category badge */}
        <span className="inline-block bg-black text-white text-micro font-semibold uppercase tracking-[0.08em] px-3 py-1 mb-4">
          {frontmatter.category}
        </span>

        {/* Title */}
        <h1 className="text-display md:text-[48px] font-black tracking-tight text-black leading-[1.05] mb-3">
          {frontmatter.title}
        </h1>
