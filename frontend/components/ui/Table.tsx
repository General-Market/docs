...
>(({ className = '', ...props }, ref) => (
  <tr
    ref={ref}
    className={`border-b border-border-light transition-colors hover:bg-surface ${className}`}
    {...props}
  />
))
...
>(({ className = '', ...props }, ref) => (
  <th
    ref={ref}
    className={`h-10 px-3.5 text-left align-middle type-table-header whitespace-nowrap [&:has([role=checkbox])]:pr-0 ${className}`}
    {...props}
  />
))
