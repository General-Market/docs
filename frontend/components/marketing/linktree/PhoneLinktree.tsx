...
function readResponsive(): Responsive {
  ...
  if (typeof window === 'undefined') {
    return { distance: 7.084, topOffset: 0, scrollTravel: 0.5, ambient: false }
  }
  ...
  if (aspect >= 1.2) {
    return { distance: 7.084, topOffset: 0, scrollTravel: 0.5, ambient }
  }
  if (aspect >= 0.7) {
    return { distance: 7.271, topOffset: 0, scrollTravel: 0.45, ambient }
  }
  return { distance: 7.458, topOffset: 0, scrollTravel: 0.4, ambient }
}
