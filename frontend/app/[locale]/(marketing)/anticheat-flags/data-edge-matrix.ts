...
export const EDGE_TOPICS: EdgeTopic[] = [
  ...
  },
  {
    ...
    lead: 'Retail baseline = 0 bps (often pays the maker fee). Bar = bps of round-trip rebate the top-tier MM receives over retail.',
    unit: 'bps round-trip rebate',
    generalMarketLabel: 'No tiers — every taker pays the same parimutuel cut',
    rows: [
      {
        slug: 'coinbase-advanced-top',
        name: 'Coinbase',
        tag: 'Tier 8 0 vs 40 bps',
        value: 40,
        gatedValue: 40,
        lane: 'Retail: 40 bps maker | MM: 0 bps + 15× thin-pair multipliers',
        barrier: 'Tier-8 + LP program',
        sources: [
          { label: 'Coinbase Exchange · Liquidity Program', url: 'https://www.coinbase.com/exchange/liquidity-program' },
        ],
      },
      {
        ...
        value: 10,
        gatedValue: 10,
        lane: 'Retail: pays 2.4¢ taker fee | MM: $10-$1k/day LIP pool through 2026-09-01 rivals taker fee',
      ...
      },
      {
        ...
        name: 'Hyperliquid',
        tag: 'Tier 6 −3 vs 1.5 bps',
        value: 4.5,
        gatedValue: 4.5,
        lane: 'Retail: 1.5 bps maker | MM: −3 bps rebate at Tier 6',
      ...
      },
      {
        ...
        name: 'Deribit',
        tag: 'VIP 6 −1 vs 3 bps',
        value: 4,
        gatedValue: 4,
        lane: 'Retail: 3 bps options maker | MM: −1 bps (66.66% discount at ≥$5B 30-day)',
        barrier: '$5B 30-day volume',
        sources: [
          { label: 'Phemex News · Deribit VIP fee system', url: 'https://phemex.com/news/article/deribit-to-launch-automated-vip-fee-system-solana-targets-260-27184' },
        ],
      },
      {
        ...
        value: 3,
        gatedValue: 3,
        lane: 'Retail: 2 bps perps maker | MM: −1 bps MM Incentive rebate',
        barrier: 'Institutional-services contract',
        sources: [
          { label: 'Bybit · MM Incentive Program', url: 'https://www.bybit.com/en/help-center/article/Introduction-to-the-Market-Maker-Incentive-Program' },
        ],
      },
      {
        ...
        name: 'Binance',
        tag: 'VIP9 + LP −0.5 vs 2 bps',
        value: 2.5,
        gatedValue: 2.5,
        lane: 'Retail: 2 bps maker | MM: 0 bps VIP 9 + USDS-M LP rebate up to −0.005%',
        barrier: 'Tier-9 + LP rebate',
        sources: [
      ...
      },
      {
        ...
        value: 2.5,
        gatedValue: 2.5,
        lane: 'Retail: pays taker fee | MM: 25% taker fee returned (20% Crypto); pro-rata to pool-dominant maker',
