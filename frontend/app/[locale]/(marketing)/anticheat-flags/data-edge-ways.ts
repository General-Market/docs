...
export const EDGE_WAYS: EdgeWay[] = [
  make(
    ...
    'Helius MEV Report documents 1.55M sandwich txs in 30 days on Solana, with an 88.9% success rate and 16 of the top 20 sandwiched tokens living on pump.fun. Per-swap incidence is inferred rather than measured; 15% is the mid-band of community estimates.',
  ...
  make(
    ...
    'The book is visible to the MM at all times. Hendershott–Riordan (JFQA 2013) measured 3.62 bps quoted spread on liquid DAX names; adverse selection from faster traders sits at 1–2 bps when the speed gap is present.',
  ...
  make(
    ...
    'Aquilina–Budish–O’Neill (QJE 2022) measured the global latency-arbitrage tax at ~0.5 bps of trading volume, around $5B/year on world equities. The page anchors directly to that figure.',
  ...
  make(
    ...
    0, 3,
    '0.5 bps peak × 1.0 trades affected = 0.5 bps per round-trip.',
    'Binance publishes one global ceiling (6,000 weight/min per IP, 100 orders per 10 s) and refuses to disclose institutional tiers. Whatever asymmetry exists is private; 0.5 bps is a placeholder, not a measurement.',
    'Binance API limits',
