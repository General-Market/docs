...
<img src="/images/vision/source-pipeline-overview.svg" alt="From your API through the data-node Rust process into Postgres, then out to Vision API, oracles, and the frontend." />

## Files You Will Touch

<img src="/images/vision/source-file-map.svg" alt="The files a new source touches: backend Rust, contracts, and frontend TypeScript." />
...
<img src="/images/vision/feed-good-vs-bad.svg" alt="Good feeds change over time and are numeric. Bad feeds are static or non-numeric." />

### Static vs Dynamic Discovery

<img src="/images/vision/discovery-modes.svg" alt="Static config files versus dynamic upstream discovery versus hybrid mix." />

### Sync Interval Decision Tree

<img src="/images/vision/sync-interval-decision.svg" alt="Cadence chosen by how fast the underlying data changes, with a rate-budget rule." />
...
<img src="/images/vision/source-implementation-patterns.svg" alt="Six fetch shapes: single fan-out, grouped, batch IDs, rolling cursor, scheduled, full-list re-fetch." />
...
<img src="/images/vision/asset-id-format.svg" alt="Asset IDs combine a source prefix with an identifier; the prefix drives category routing." />
...
<Note>
Only if your API requires an API key. Skip this section for open or free APIs.
</Note>
...
<img src="/images/vision/s-helper-signature.svg" alt="The S() helper signature with each argument and the contract it carries." />
...
<img src="/images/vision/source-test-flow.svg" alt="Four-step test flow: curl the API, cargo check, cargo test the source, tsc --noEmit." />
...
<img src="/images/vision/source-pitfalls.svg" alt="Eight pitfalls common to every new source, from rate limits to graceful frontend degradation." />
...
<img src="/images/vision/new-source-checklist.svg" alt="New source checklist across backend, contracts, frontend, and verification." />
