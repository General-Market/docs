...
<img src="/images/vision/sources-browser-overview.svg" alt="Listing page on the left, detail page on the right, an arrow between them labeled CLICK." />
...
<img src="/images/vision/category-nav-bar.svg" alt="Ten category filter pills with counts, the All pill active." />
...
<img src="/images/vision/source-card-anatomy.svg" alt="Source card with logo, category badge, status dot, description, stats triplet, and three action buttons." />
...
<img src="/images/vision/source-hover-overlay.svg" alt="Hover overlay panel listing markets sorted by value, left borders color-coded UP, DOWN, or unset." />
...
<img src="/images/vision/source-detail-layout.svg" alt="Full source detail page: category nav, hero, batch tick bar, markets table with chart, batch entry panel, leaderboard." />
...
<img src="/images/vision/batch-tick-bar.svg" alt="Batch status bar: tick number, player count, pool size, progress bar, multiplier, set count, countdown timer." />
...
<img src="/images/vision/markets-table.svg" alt="Markets table with one row expanded to reveal a 24-hour price history sparkline." />
...
<img src="/images/vision/market-id-anatomy.svg" alt="Four market IDs split into prefix and asset pills, each with a one-line description." />
...
<img src="/images/vision/price-history-chart.svg" alt="Twenty-four-hour BTC-USD price chart with axis labels and the latest value marked at the right edge." />
...
<img src="/images/vision/value-types-by-source.svg" alt="Fourteen sources with their value label, unit, and an example value." />
...
<img src="/images/vision/tick-resolution-flow.svg" alt="Tick resolution: start price, end price, delta, UP result, and how winners split losers' stakes." />
...
<img src="/images/vision/source-monitoring.svg" alt="Monitoring dashboard: KPI strip with totals and a per-source health table." />
