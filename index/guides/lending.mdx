...
1. Health factor falls below 1.0 (DTF NAV dropped, or interest accrued).
...
4. In return, the liquidator receives an equivalent value of DTF collateral **plus a liquidation bonus** (discount).
