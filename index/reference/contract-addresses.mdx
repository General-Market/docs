...
<img src="/images/index/contract-topology.svg" alt="Contract topology — which contracts live on L3, which live on Settlement, and the bridge that connects them." />
