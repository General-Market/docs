...
impl Default for ConsensusTimeouts {
    fn default() -> Self {
        Self {
            // Total must fit within 1s cycle: 200+150+200+250 = 800ms
            price_proposal_timeout: Duration::from_millis(200),
            price_vote_timeout: Duration::from_millis(150),
            batch_proposal_timeout: Duration::from_millis(200),
            batch_sign_timeout: Duration::from_millis(250),
...
mod tests {
    ...
    fn test_consensus_timeouts_default() {
        ...
        // Must fit within 1s cycle: 200+150+200+250 = 800ms
        assert_eq!(timeouts.price_proposal_timeout, Duration::from_millis(200));
        assert_eq!(timeouts.price_vote_timeout, Duration::from_millis(150));
        assert_eq!(timeouts.batch_proposal_timeout, Duration::from_millis(200));
        assert_eq!(timeouts.batch_sign_timeout, Duration::from_millis(250));
        assert_eq!(timeouts.polling_interval, Duration::from_millis(10));
    }

    #[test]
    fn test_consensus_timeouts_total_fits_in_cycle() {
        let timeouts = ConsensusTimeouts::default();
        assert_eq!(timeouts.total_timeout_ms(), 800);
