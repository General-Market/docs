...
/// Use [`extract_issuer_id`] to recover the original node_id from a peer_id.
...
/// Extract the issuer/node ID from a peer_id generated by [`generate_peer_id`].
///
/// Returns the original `node_id` that was passed to `generate_peer_id`.
/// This is the on-chain issuer ID used for bitmap computation.
pub fn extract_issuer_id(peer_id: &[u8; 32]) -> u32 {
