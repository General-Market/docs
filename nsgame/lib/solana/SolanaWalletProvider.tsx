      ...
      <WalletProvider wallets={wallets} autoConnect>
        <UnifiedWalletProvider
          ...
          config={{
            ...
            metadata: {
              name: 'nsgame',
              description: 'Session-wallet prediction market on Solana',
              url: typeof window !== 'undefined' ? window.location.origin : 'https://nsgame.io',
              iconUrls: ['https://nsgame.io/icon-192.png'],
            },
            theme: 'dark',
            lang: 'en',
          }}
